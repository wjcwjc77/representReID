...
import models
from util.losses import CrossEntropyLoss, CrossEntropyLabelSmooth
...
parser = argparse.ArgumentParser(description='Train ReID')
# Datasets
parser.add_argument('--root', type=str, default='D:\\deepLearning\\reID_pytorch\\data', #your root path
...
parser.add_argument('--max-epoch', default=2, type=int,
...
parser.add_argument('--weight-decay', default=5e-04, type=float,
                    help="weight decay (default: 5e-04)")  # 使得模型的复杂度不会太高，防止过拟合
# triplet hard loss
...
def main():
    ...
    if use_gpu:
        ...
        cudnn.benchmark = True  # cudnn 是用来对卷积进行加速的
    ...
    transform_train = T.Compose([
        T.Random2DTranslation(args.height, args.width),  # 放大，再裁剪
